...
# then read imported_path, is_relative
source_file=""
imported_path=""
is_relative=""
...
while IFS= read -r line; do
  if echo "$line" | grep -qE "^\s+- source_file:"; then
    ...
    # When we have a complete record, validate
